...
dv_total = manuever_v + norm(v_inc_change - [target_v,0])
...
plot3(target_orbit_statematrix(:,2),target_orbit_statematrix(:,3),target_orbit_statematrix(:,4),"r")

%scatter3(target_r_initial(1),target_r_initial(2),target_r_initial(3),"r","filled")

quiver3(0,0,0,target_normal(1)*unit_vec_size,target_normal(2)*unit_vec_size,target_normal(3)*unit_vec_size,"r")
quiver3(0,0,0,lunar_normal(1)*unit_vec_size,lunar_normal(2)*unit_vec_size,lunar_normal(3)*unit_vec_size,"b")
