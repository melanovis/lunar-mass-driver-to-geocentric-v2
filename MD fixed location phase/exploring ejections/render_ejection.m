function render_ejection(TA_start_norm, eject_v, launch_azimuth, launch_elevation, launch_long, launch_lat)
...
for n=1:2
    ...
    if n==2
        ...
        "launch $\theta$ = " + round(launch_azimuth,3) +"$^{\circ}$" + ", " + "launch $\epsilon$ = " + round(launch_elevation,4) +"$^{\circ}$" + newline +...
