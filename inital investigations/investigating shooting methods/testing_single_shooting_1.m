...
r_rocket_start = [0, 3.4e8, 0e8];

[v_1,v_2,delta_t] = lambert_solve(r_rocket_start, r_target, 0.5, G*earth_mass)
v_guess_inital = v_1;

rocket_start_statematrix = [t_start, r_rocket_start, v_guess_inital]; %just test values for now
...
min_target = norm(scene_rocket_statematrix(ind_target_min,2:4))
...
plot3(scene_rocket_statematrix(1:ind_target_min,2),scene_rocket_statematrix(1:ind_target_min,3),scene_rocket_statematrix(1:ind_target_min,4),"r")
